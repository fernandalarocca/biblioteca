...
return [
    ...
    'laravel' => [
         ...
         * By default, assets are stored in `public/vendor/api-documentation`.
...
INTRO
     ...
     * For 'laravel' docs, it will be generated to storage/app/api-documentation/collection.json.
     ...
     * For 'laravel' docs, it will be generated to storage/app/api-documentation/openapi.yaml.
